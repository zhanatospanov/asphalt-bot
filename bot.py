...
def main():
    ...
    app.add_handler(CommandHandler("obj",     cmd_object))
    ...
    async def post_init(application):
        await application.bot.set_my_commands([
            ...
            BotCommand("grade",   "Марка асфальта / вид инертного материала"),
            BotCommand("temp",    "Температура смеси (только для асфальта)"),
